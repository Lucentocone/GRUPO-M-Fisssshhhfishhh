...
1. Definir entidad Rol.
2. Crear relación entre Usuario, Evento y Rol.
3. Implementar endpoint para asignación de roles.
4. Implementar consulta de roles por usuario.
5. Implementar modificación de roles.
